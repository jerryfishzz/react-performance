...
> NOTE: There have been reports of issues running this exercise. It's
> inexplicable, but some have found that a "solution" is to simply edit the
> `src/filter-cities.js` file. Add a comment or a console.log in there and
> magically things start working again. Bonus points if you can figure out
> what's going wrong and fix it in whatever library is messing things up. Sorry
> for the trouble!
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=02%3A%20useMemo%20for%20expensive%20calculations&em=jerryfishzz%40gmail.com).
